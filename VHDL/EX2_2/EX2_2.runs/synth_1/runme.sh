...
HD_PWD='D:/Project/VHDL/EX2_2/EX2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log in4out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source in4out.tcl
