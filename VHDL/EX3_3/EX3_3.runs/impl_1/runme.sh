...
HD_PWD='D:/Project/VHDL/EX3_3/EX3_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit2led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit2led.tcl -notrace
