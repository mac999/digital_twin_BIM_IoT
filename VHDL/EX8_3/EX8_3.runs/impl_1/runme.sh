...
HD_PWD='D:/Project/VHDL/EX8_3/EX8_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EX8_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EX8_3.tcl -notrace
