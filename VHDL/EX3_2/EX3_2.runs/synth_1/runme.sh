...
HD_PWD='D:/Project/VHDL/EX3_2/EX3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit2led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit2led.tcl
