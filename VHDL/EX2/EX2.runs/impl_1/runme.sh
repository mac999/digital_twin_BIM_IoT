...
HD_PWD='D:/Project/VHDL/EX2/EX2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ander.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ander.tcl -notrace
