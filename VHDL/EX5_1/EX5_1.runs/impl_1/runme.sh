...
HD_PWD='D:/Project/VHDL/EX5_1/EX5_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EX5_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EX5_1.tcl -notrace
