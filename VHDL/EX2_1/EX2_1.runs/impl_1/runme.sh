...
HD_PWD='D:/Project/VHDL/EX2_1/EX2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log in4out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source in4out.tcl -notrace
