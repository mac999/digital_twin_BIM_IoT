...
HD_PWD='D:/Project/VHDL/EX9_2/EX9_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter3.tcl -notrace
