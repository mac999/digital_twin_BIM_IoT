...
HD_PWD='D:/Project/VHDL/EX9_2/EX9_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter3.tcl
